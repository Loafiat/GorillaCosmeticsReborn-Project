...
public class BadgeInspector : Editor
{
    public bool DebugInfo = false;
    
    public override void OnInspectorGUI()
    {
        BadgeDescriptor hTarget = (BadgeDescriptor)this.target;
    ...
    public void CalculateHatOffset(BadgeDescriptor hTarget)
    {
    ...
    public void GenerateHatIcon(BadgeDescriptor hTarget)
    {
