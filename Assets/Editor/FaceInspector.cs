...
[CustomEditor(typeof(FaceDescriptor))]
public class FaceInspector : Editor
{
    ...
    {
        FaceDescriptor hTarget = (FaceDescriptor)this.target;
    ...
    public void CalculateHatOffset(FaceDescriptor hTarget)
    {
    ...
    public void GenerateHatIcon(FaceDescriptor hTarget)
    {
